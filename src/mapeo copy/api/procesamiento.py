...
from salud_tech.modulos.procesamiento.aplicacion.mapeadores import MappeadorParquetDTOJson
from salud_tech.modulos.procesamiento.aplicacion.comandos.create_dataset import CreateParquet
...
bp = api.crear_blueprint('mapeo', '/mapeo')
...
@bp.route('/crear-parquet-comando', methods=['POST'])
