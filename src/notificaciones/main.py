...
consumer = client.subscribe('eventos-dataset-medico', consumer_type=_pulsar.ConsumerType.Shared, subscription_name='sub-notificacion-eventos-datasets-medicos', schema=AvroSchema(EventoReservaCreada))
